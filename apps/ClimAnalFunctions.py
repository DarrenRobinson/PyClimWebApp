...
# file = open(os.path.join(pathlib.Path(__file__).parent.absolute(), "Finningley.csv"), "r")
# lat = 53.7
# longitude = -1
# timezone = 0
...
#Underground Space Vol.7 pp037-65, 1982  
    ...
    Tground = t_mean - t_swing*Decrement*math.cos(2*pi*(cum_monthdaydaynum_list-dayofminmean-depth*Lag)/365)
    return Tground
